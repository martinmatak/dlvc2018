...
class CatDogNet(nn.Module):
    def __init__(self):
        ...
        self.linear_layer1 = nn.Linear(in_features=3072, out_features=6144)
        self.batch_norm_layer1 = nn.BatchNorm1d(num_features=6144)
        self.linear_layer2 = nn.Linear(in_features=6144, out_features=6144)
        self.batch_norm_layer2 = nn.BatchNorm1d(num_features=6144)
        self.linear_layer3 = nn.Linear(in_features=6144, out_features=6144)
        self.batch_norm_layer3 = nn.BatchNorm1d(num_features=6144)
        self.linear_layer4 = nn.Linear(in_features=6144, out_features=6144)
        self.batch_norm_layer4 = nn.BatchNorm1d(num_features=6144)
        self.linear_layer5 = nn.Linear(in_features=6144, out_features=6144)
        self.batch_norm_layer5 = nn.BatchNorm1d(num_features=6144)
        self.linear_layer6 = nn.Linear(in_features=6144, out_features=6144)
        self.batch_norm_layer6 = nn.BatchNorm1d(num_features=6144)
        self.linear_layer7 = nn.Linear(in_features=6144, out_features=6144)
        self.batch_norm_layer7 = nn.BatchNorm1d(num_features=6144)
        self.linear_layer8 = nn.Linear(in_features=6144, out_features=6144)
        self.batch_norm_layer8 = nn.BatchNorm1d(num_features=6144)
        self.linear_layer9 = nn.Linear(in_features=6144, out_features=NUM_CLASSES)
